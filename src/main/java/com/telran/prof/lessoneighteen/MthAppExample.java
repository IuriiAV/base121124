 ...
 * время и память
 * Когда мы запускаем какое либо приложение, то одному экзепляру данного приложения,
 ...
 * Один процесс может состоять из более чем 1 потока, в Java главный поток приложения может
 ...
 * это дочерние потоки потока main, а поток main является
 * их родителем
 *
...
public class MthAppExample {
    ...
    public static void main(String[] args) {
        ...
        // написанный в методе run, объекта, которые передан в конструктор
